  ...
  return (
    <main className="min-h-screen bg-black text-white flex justify-center">
      ...
      <div className="max-w-3xl w-full p-10 mt-20">
        ...
        {/* SKILLS */}
        <section id="skills" className="mt-10 bg-neutral-900 p-6 rounded-xl border border-neutral-800">
          <h2 className="text-2xl font-semibold">Skills</h2>

          <div className="flex flex-wrap gap-3 mt-4">
            <span className="bg-black border border-neutral-700 px-3 py-1 rounded-full text-sm">Python</span>
            <span className="bg-black border border-neutral-700 px-3 py-1 rounded-full text-sm">SQL</span>
            <span className="bg-black border border-neutral-700 px-3 py-1 rounded-full text-sm">Excel</span>
            <span className="bg-black border border-neutral-700 px-3 py-1 rounded-full text-sm">Power BI</span>
          </div>
        </section>

        {/* PROJECTS */}
        <section id="projects" className="mt-10 bg-neutral-900 p-6 rounded-xl border border-neutral-800">
